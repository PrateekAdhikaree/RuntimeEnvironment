...
public class SuperAdminProfileJPanel extends javax.swing.JPanel {
     ...
     */
    public SuperAdminProfileJPanel(JPanel userProcessContainer, UserAccount userAccount, Accounting accounting, Business business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SuperAdmin Profile");
...
private Boolean validateSuperAdminProfile() {
        int dialogShown = 0;
        Pattern pattern;
        Matcher matcher;
    ...
    private void setSuperAdminProfileToObj() {
    ...
    public void setSuperAdminProfileToForm(){
        Employee employee = userAccount.getEmployee();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        Boolean isValid = validateSuperAdminProfile();
        if (isValid) {
            setSuperAdminProfileToObj();
        }
