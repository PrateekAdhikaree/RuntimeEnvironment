 ...
 * @author soumiyaroy
 */
public class AccountantProfileJPanel extends javax.swing.JPanel {
     ...
     */
    public AccountantProfileJPanel(JPanel userProcessContainer, UserAccount userAccount, Accounting accounting, Business business) {
        initComponents();
    ...
    private void setAccountProfileToObj(){
    ...
    public void setAccountantToForm(){
        Employee employee = userAccount.getEmployee();
