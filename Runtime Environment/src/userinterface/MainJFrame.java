...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (userAccount == null) {
            ...
            userProcessContainer.add(userAccount.getRole().toString()+"WorkArea", userAccount.getRole().createWorkArea(userProcessContainer, userAccount, selectedEnterprise, business));
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
            layout.next(userProcessContainer);
        }
    ...
    private void btnProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProfileActionPerformed
        ...
        if(selectedEnterprise == null)
            ...
            accounting = selectedEnterprise.getOrganizationDirectory().getAccounting();
        
        userProcessContainer.add("Profile", this.userAccount.getRole().createProfile(userProcessContainer, userAccount, accounting, business));
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
