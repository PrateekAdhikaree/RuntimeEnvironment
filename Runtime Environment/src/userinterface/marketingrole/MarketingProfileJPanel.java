...
private Boolean validateMarketingProfile() {
        int dialogShown = 0;
        Pattern pattern;
        Matcher matcher;
    ...
    private void setMarketingProfileToObj() {
    ...
    public void setMarketingProfileToForm(){
        Employee employee = userAccount.getEmployee();
