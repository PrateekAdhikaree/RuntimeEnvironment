...
public class MaintenanceProfileJPanel extends javax.swing.JPanel {
     ...
     */
    public MaintenanceProfileJPanel(JPanel userProcessContainer, UserAccount userAccount, Accounting accounting, Business business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Maintenance Manager Profile");
...
private Boolean validateMaintenanceProfile() {
        int dialogShown = 0;
        Pattern pattern;
        Matcher matcher;
    ...
    private void setMaintenanceProfileToObj() {
    ...
    public void setMaintenanceToForm(){
        Employee employee = userAccount.getEmployee();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        Boolean isValid = validateMaintenanceProfile();
        if (isValid) {
            setMaintenanceProfileToObj();
        }
